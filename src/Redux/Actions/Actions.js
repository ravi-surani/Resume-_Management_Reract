  ...
  return (Dispatch) => {
    ...
    Services.getService("allusers").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ALL_USER_SUCESS,
            data: response.user,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ALL_USER_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.GET_ALL_USER_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.postService("register", details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.CREATE_NEW_USER_SUCESS,
            data: response.user,
          });
        } else {
          return Dispatch({
            type: Constants.CREATE_NEW_USER_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.postService("remove/" + details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_USER_SUCESS,
            data: response.user,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_USER_FAILED,
            data: response,
          });
        }
      },
...
const setUserLoginDetails = (details) => {
  return (Dispatch) => {
    return Dispatch({ type: Constants.USER_LOG_IN_SUCESS, data: details });
  };
};
...
const userLogout = () => {
  ...
  window.location.reload();
  return (Dispatch) => {
    return Dispatch({ type: Constants.USER_LOG_IN_SUCESS, data: null });
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.getService("candidatemaster/" + id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_CANDIDATES_BY_ID_SUCESS,
            data: response.candidate,
          });
        } else {
          return Dispatch({
            type: Constants.GET_CANDIDATES_BY_ID_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.patchService("candidatemaster", details.id, details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.UPDATE_CANDIDATES_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.UPDATE_CANDIDATES_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("candidatemaster", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_CANDIDATES_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_CANDIDATES_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("sourcemaster").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ALL_SOURCE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ALL_SOURCE_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.GET_ALL_SOURCE_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.getService("getactivesource").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ACTIVE_SOURCE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ACTIVE_SOURCE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("sourcemaster/" + id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.ADD_SOURCE_BY_ID_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.ADD_SOURCE_BY_ID_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.postService("sourcemaster", details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.ADD_SOURCE_SUCESS,
            data: response.source,
          });
        } else {
          return Dispatch({
            type: Constants.ADD_SOURCE_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.ADD_SOURCE_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.patchService("sourcemaster", details?.id, details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.UPDATE_SOURCE_SUCESS,
            data: response.source,
          });
        } else {
          return Dispatch({
            type: Constants.UPDATE_SOURCE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("sourcemaster", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_SOURCE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_SOURCE_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.REMOVE_SOURCE_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.getService("skillmaster").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ALL_SKILL_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ALL_SKILL_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.GET_ALL_SKILL_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.getService("getactiveskill").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ACTIVE_SKILL_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ACTIVE_SKILL_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("skillmaster/" + id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_SKILL_BY_ID_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_SKILL_BY_ID_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.postService("skillmaster", details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.ADD_SKILL_SUCESS,
            data: response.skill,
          });
        } else {
          return Dispatch({ type: Constants.ADD_SKILL_FAILED, data: response });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.ADD_SKILL_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.patchService("skillmaster", details?.id, details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.UPDATE_SKILL_SUCESS,
            data: response.skill,
          });
        } else {
          return Dispatch({
            type: Constants.UPDATE_SKILL_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.UPDATE_SKILL_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("skillmaster", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_SKILL_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_SKILL_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.REMOVE_SKILL_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.getService("skilltypemaster").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ALL_SKILL_TYPE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ALL_SKILL_TYPE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("skilltypemaster/" + id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_SKILL_TYPE_BY_ID_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_SKILL_TYPE_BY_ID_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.postService("skilltypemaster", details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.ADD_SKILL_TYPE_SUCESS,
            data: response.skill_type,
          });
        } else {
          return Dispatch({
            type: Constants.ADD_SKILL_TYPE_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.ADD_SKILL_TYPE_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.patchService("skilltypemaster", details?.id, details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.UPDATE_SKILL_TYPE_SUCESS,
            data: response.skill_type,
          });
        } else {
          return Dispatch({
            type: Constants.UPDATE_SKILL_TYPE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("skilltypemaster", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_SKILL_TYPE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_SKILL_TYPE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("recruitmentstatusmaster").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ALL_RECRUITMENT_STATUS_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ALL_RECRUITMENT_STATUS_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("getactiverecruitmentstatus").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ACTIVE_RECRUITMENT_STATUS_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ACTIVE_RECRUITMENT_STATUS_FAILED,
            data: response,
          });
        }
      },
    ...
    Services.postService("recruitmentstatusmaster", details).then(
      (response) => {
        if (response.success) {
          ...
          return Dispatch({
            type: Constants.ADD_RECRUITMENT_STATUS_FAILED,
            data: response,
          });
        }
      },
    ...
    Services.patchService("recruitmentstatusmaster", details?.id, details).then(
      (response) => {
        if (response.success) {
          ...
          return Dispatch({
            type: Constants.UPDATE_RECRUITMENT_STATUS_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("recruitmentstatusmaster", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_RECRUITMENT_STATUS_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_RECRUITMENT_STATUS_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("modeofworkmaster").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ALL_MODE_OF_WORK_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ALL_MODE_OF_WORK_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("getactiveremodeofwork").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ACTIVE_MODE_OF_WORK_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ACTIVE_MODE_OF_WORK_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.postService("modeofworkmaster", details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.ADD_MODE_OF_WORK_SUCESS,
            data: response.mode_of_work,
          });
        } else {
          return Dispatch({
            type: Constants.ADD_MODE_OF_WORK_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.patchService("modeofworkmaster", details?.id, details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.UPDATE_MODE_OF_WORK_SUCESS,
            data: response.mode_of_work,
          });
        } else {
          return Dispatch({
            type: Constants.UPDATE_MODE_OF_WORK_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("modeofworkmaster", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_MODE_OF_WORK_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_MODE_OF_WORK_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("interviewtypemaster").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ALL_INTERVIEW_TYPE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ALL_INTERVIEW_TYPE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("getactiveinterviewtype").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ACTIVE_INTERVIEW_TYPE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ACTIVE_INTERVIEW_TYPE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.postService("interviewtypemaster", details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.ADD_INTERVIEW_TYPE_SUCESS,
            data: response.interview_type,
          });
        } else {
          return Dispatch({
            type: Constants.ADD_INTERVIEW_TYPE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.patchService("interviewtypemaster", details?.id, details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.UPDATE_INTERVIEW_TYPE_SUCESS,
            data: response.interview_type,
          });
        } else {
          return Dispatch({
            type: Constants.UPDATE_INTERVIEW_TYPE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("interviewtypemaster", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_INTERVIEW_TYPE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_INTERVIEW_TYPE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("interviewermaster").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ALL_INTERVIEWER_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ALL_INTERVIEWER_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("getactiveinterviewer").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ACTIVE_INTERVIEWER_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ACTIVE_INTERVIEWER_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.postService("interviewermaster", details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.ADD_INTERVIEWER_SUCESS,
            data: response.Interviewer,
          });
        } else {
          return Dispatch({
            type: Constants.ADD_INTERVIEWER_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.patchService("interviewermaster", details?.id, details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.UPDATE_INTERVIEWER_SUCESS,
            data: response.Interviewer,
          });
        } else {
          return Dispatch({
            type: Constants.UPDATE_INTERVIEWER_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("interviewermaster", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_INTERVIEWER_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_INTERVIEWER_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("interviewmodemaster").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ALL_INTERVIEW_MODE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ALL_INTERVIEW_MODE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.postService("interviewmodemaster", details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.ADD_INTERVIEW_MODE_SUCESS,
            data: response.interview_mode,
          });
        } else {
          return Dispatch({
            type: Constants.ADD_INTERVIEW_MODE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.patchService("interviewmodemaster", details?.id, details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.UPDATE_INTERVIEW_MODE_SUCESS,
            data: response.interview_mode,
          });
        } else {
          return Dispatch({
            type: Constants.UPDATE_INTERVIEW_MODE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("interviewmodemaster", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_INTERVIEW_MODE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_INTERVIEW_MODE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.getService("degreemaster").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ALL_DEGREE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ALL_DEGREE_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.GET_ALL_DEGREE_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.getService("degreemaster").then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_ACTIVE_DEGREE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_ACTIVE_DEGREE_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.postService("degreemaster", details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.ADD_DEGREE_SUCESS,
            data: response.degree,
          });
        } else {
          return Dispatch({
            type: Constants.ADD_DEGREE_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.ADD_DEGREE_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.patchService("degreemaster", details?.id, details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.UPDATE_DEGREE_SUCESS,
            data: response.degree,
          });
        } else {
          return Dispatch({
            type: Constants.UPDATE_DEGREE_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.UPDATE_DEGREE_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("degreemaster", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_DEGREE_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_DEGREE_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.REMOVE_DEGREE_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.getService("interviews/" + id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.GET_INTERVIEWS_BY_ID_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.GET_INTERVIEWS_BY_ID_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.postService("interviews", details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.ADD_INTERVIEWS_SUCESS,
            data: response.interview_details,
          });
        } else {
          return Dispatch({
            type: Constants.ADD_INTERVIEWS_FAILED,
            data: response,
          });
        }
      },
      (error) => {
        return Dispatch({ type: Constants.ADD_INTERVIEWS_FAILED, data: error });
      }
    );
  };
};
  ...
  return (Dispatch) => {
    ...
    Services.patchService("interviews", details?.id, details).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.UPDATE_INTERVIEWS_SUCESS,
            data: response.degree,
          });
        } else {
          return Dispatch({
            type: Constants.UPDATE_INTERVIEWS_FAILED,
            data: response,
          });
        }
      },
  ...
  return (Dispatch) => {
    ...
    Services.deleteService("interview", id).then(
      (response) => {
        if (response.success) {
          return Dispatch({
            type: Constants.REMOVE_INTERVIEWS_SUCESS,
            data: response.data,
          });
        } else {
          return Dispatch({
            type: Constants.REMOVE_INTERVIEWS_FAILED,
            data: response,
          });
        }
      },
