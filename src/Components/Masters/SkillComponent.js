...
function SkillComponent({
  ...
  return (
    <>
      <NevbarComponent
        title={"Skills List"}
        breadcrumbPath={[{ link: "skills", value: "Skill List" }]}
      />
      <SidebarComponent />
              ...
              <form onSubmit={props.handleSubmit}>
                <div className="modal-body">
                  <div className="form-group row">
                    <label htmlFor="skill" className="col-sm-2 col-form-label">
                      Skill
                    </label>
                    <div className="col-sm-10">
                      <input
                        ...
                        className={
                          "form-control " +
                          (formik?.errors?.skill ? " border-danger " : "") +
                          " "
                        }
                      ...
                      >
                        ...
                        {activeSkillTypeResponse && activeSkillTypeResponse.map((skillsType) => (
                          <option
                            value={skillsType.id}
                            selected={
                              formik?.values?.skill_type_id == skillsType.id
                                ? true
                                : false
                            }
                          >
                            {skillsType.skill_type}{" "}
                          </option>
                        ))}
                      </select>
