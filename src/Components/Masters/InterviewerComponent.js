          ...
          action: (
            <div className="btn-group ">
              ...
              {/* <button
                ...
                onClick={() => onSkillTypeRemove(interviewer.id)}
              >
                Remove
              </button> */}
            </div>
  ...
  return (
    <>
      <NevbarComponent
        ...
        breadcrumbPath={[{ link: "interviewer", value: "Interviewer List" }]}
      />
      <SidebarComponent />
...
const mapStatetoProps = (state) => {
  return {
    ...
    interviewerRemovedProp:
      state?.removedInterviewerReducer?.interviewerRemoved,
  };
};
...
const mapDispatchtoProps = {
  ...
  updateInterviewerDetailsAction: (details) =>
    updateInterviewerDetails(details),
