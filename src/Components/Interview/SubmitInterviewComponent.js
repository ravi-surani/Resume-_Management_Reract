...
import { getInterviewById, getActiveInterviewType, getActiveInterviewer, getAllInterviewMode, addNewInterview } from '../../Redux/Actions/Actions';

import SidebarComponent from '../SidebarComponent';
import NevbarComponent from '../NevbarComponent';
import { Link, useParams } from 'react-router-dom';

function SubmitInterviewComponent({ interviewsDetialsProp, interviewTypesListProp, interviewerListProp, interviewModeListProp, newInterviewsProp,
    getInterviewByIdAction, getActiveInterviewTypeAction, getActiveInterviewerAction, getAllInterviewModeAction, addNewInterviewAction }) {
                                                                ...
                                                                <div className="col-4 ">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        {interviewerListProp?.map(interviewer => {
                                                                            return <option value={interviewer.id} selected={formikScheduleInterviewForm?.values?.interviewer_id == interviewer.id ? true : false} >{interviewer.name} </option>
                                                                        }
                                                                        )}
                                                                    </select>
                                                                ...
                                                                <div className="col-4 ">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        {interviewModeListProp?.map(mode => {
                                                                            return <option value={mode.id} selected={formikScheduleInterviewForm?.values?.mode_id == mode.id ? true : false} >{mode.interview_mode} </option>
                                                                        }
                                                                        )}
                                                                    </select>
...
export default connect(mapStatetoProps, mapDispatchtoProps)(SubmitInterviewComponent)