...
function SidebarComponent({ userDetailsProps, setUserLoginDetailsAction, userLogoutActon }) {
    ...
    useEffect(() => {
        ...
        else if (!userDetailsProps && !JSON.parse(localStorage.getItem('login_user'))) {
                ...
                <div className="sidebar">
                    ...
                    <nav className="mt-2">
                        <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li className="nav-item">
                                <span onClick={() => logoutAction()} className="nav-link text-left text-red ">Logout</span>
                            </li>
