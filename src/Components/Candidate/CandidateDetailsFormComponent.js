...
import { getCandidateById, getActiveSkill, getActiveSource, getActiveDegree, getActiveModeOfWorkStatus, getActiveRecruitmentStatus, updateCandidateDetails, addNewCandidate } from '../../Redux/Actions/Actions';

import SidebarComponent from '../SidebarComponent';
import NevbarComponent from '../NevbarComponent';
import { Link, useNavigate, useParams } from 'react-router-dom';

function CandidateDetailsComponent({ candidateDetialsProp, sourceListProp, degreeListProp, skillListProp, modeOfWorkListProp, recruitmentStatusListProps, newCandidateProps, updatedCandidateProps,
    addNewCandidateAction, updateCandidateDetailsAction, getActiveSkillAction, getActiveSourceAction, getCandidateByIdAction, getActiveDegreeAction, getActiveModeOfWorkStatusAction, getActiveRecruitmentStatusAction, }) {
                                ...
                                <div className="wrapper">
                                    <section className="content">
                                        ...
                                        <div className='row'>
                                            ...
                                            <div className='col-3'>
                                                <div className="card">
                                                    <div className='card-header bg-secondary'>Date of Birth</div>
                                                    <div className="card-body">
                        ...
                        {props => (
                            <form onSubmit={props.handleSubmit}>
                                <div className="modal-body">
                                    ...
                                    <div className="form-group row">
                                        <label htmlFor="self_rating" className="col-sm-3 col-form-label">Ratings </label>
                                        <div className="col-sm-9">
                                            <input
                                                id="self_rating"
                                                name="self_rating"
...
export default connect(mapStatetoProps, mapDispatchtoProps)(CandidateDetailsComponent)