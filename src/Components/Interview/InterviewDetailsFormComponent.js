...
import { getCandidateById, getAllSkill, getAllSource, getAllDegree, getAllModeOfWorkStatus, getAllRecruitmentStatus, updateCandidateDetails, addNewCandidate } from '../../Redux/Actions/Actions';

import SidebarComponent from '../SidebarComponent';
import NevbarComponent from '../NevbarComponent';
import { Link, useNavigate, useParams } from 'react-router-dom';

function InterviewDetailsFormComponent({ candidateDetialsProp, sourceListProp, degreeListProp, skillListProp, modeOfWorkListProp, recruitmentStatusListProps, newCandidateProps, updatedCandidateProps,
    addNewCandidateAction, updateCandidateDetailsAction, getAllSkillAction, getAllSourceAction, getCandidateByIdAction, getAllDegreeAction, getAllModeOfWorkStatusAction, getAllRecruitmentStatusAction, }) {
    ...
    const formikPrevisCompaniesForm = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            formikForm.setFieldValue('previs_companies', [...formikForm.values.previs_companies, values]);
    ...
    const removeCompany = (company) => {
        ...
        tempList.splice(tempList.findIndex(skl => skl.id == company.id), 1)
        ...
        <>
                        ...
                        <form onSubmit={props.handleSubmit}>
                            <div className="container-fluid px-5">
                                <div className="content-header row">
                                    ...
                                    <Link to={'/candidate'} className="btn btn-danger col-1 ">Back</Link>
                                    <button type='submit' className="btn btn-primary col-1 ">Save</button>
                                </div>
                                <div className="wrapper">
                                    <section className="content">
                                                ...
                                                <div className='d-flex justify-content-between '>
                                                    <div className="row p-1 w-75">
                                                        ...
                                                        {formikForm.touched.name && formikForm.errors.name ? (
                                                            <span className="text-danger small">{formikForm.errors.name}</span>
                                                        ) : null}
                                                    </div>
                                                    <div className="">
                                                        ...
                                                        />
                                                        {formikForm.touched.resume_id && formikForm.errors.resume_id ? (
                                                            <span className="text-danger small">{formikForm.errors.resume_id}</span>
                                                        ) : null}
                                                    </div>
                                                </div>
                                                <div className="">
                                                    <label htmlFor="remarks" className="font-weight-normal mt-2 h6">Remarks</label>
                                                    <div className="">
                                                        <input
                                                            id="remarks"
                                                            name="remarks"
                                                        ...
                                                        {formikForm.touched.remarks && formikForm.errors.remarks ? (
                                                            <span className="text-danger small">{formikForm.errors.remarks}</span>
                                                        ) : null}
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className='row'>
                                            <div className='col-6'>
                                                <div className="card">
                                                    <div className='card-header bg-secondary'>
                                                        ...
                                                        <button type='button' className='btn btn-light btn-sm col-2' onClick={() => setSkillDataModel(true)}>Add</button>
                                                    </div>
                                                    <div className="card-body">
                                                        ...
                                                        <table className='table'>
                                                            ...
                                                            <tbody>
                                                                {formikForm.touched.skills && formikForm.errors.skills ? (
                                                                    <span className="text-danger">{formikForm.errors.skills}</span>
                                                                ) : null}
                                                                {formikForm.values?.skills?.map(skill => {
                                                                    ...
                                                                    return <tr>
                                                                        ...
                                                                        <th className='btn-group'>
                                                                            <button type='button' className='btn btn-sm bg-gradient-danger ' onClick={() => removeSkill(skill)}>Remove </button>
                                                                        </th>
                                                                    </tr>
                                                                })}
                                                            </tbody>
                                            ...
                                            <div className='col-6'>
                                                <div className="card">
                                                    <div className='card-header bg-secondary'>Contact Details</div>
                                                    <div className="card-body">
                                                        <div className="row">
                                                            <div className="col-6">
                                                                ...
                                                                <div className="">
                                                                    ...
                                                                    {formikForm.touched.email && formikForm.errors.email ? (
                                                                        <span className="text-danger small">{formikForm.errors.email}</span>
                                                                    ) : null}
                                                                </div>
                                                            </div>
                                                            <div className="col-6">
                                                                ...
                                                                <div className="">
                                                                    ...
                                                                    />
                                                                    {formikForm.touched.contect_no && formikForm.errors.contect_no ? (
                                                                        <span className="text-danger small">{formikForm.errors.contect_no}</span>
                                                                    ) : null}
                                                                </div>
                                                            </div>
                                                            <div className="col-6">
                                                                <label htmlFor="address" className="font-weight-normal mt-2 h6">Address</label>
                                                                <div className="">
                                                                    <input
                                                                        id="address"
                                                                        name="address"
                                                                    ...
                                                                    {formikForm.touched.address && formikForm.errors.address ? (
                                                                        <span className="text-danger small">{formikForm.errors.address}</span>
                                                                    ) : null}
                                                                </div>
                                                            </div>
                                                            <div className="col-6">
                                                                <label htmlFor="city" className="font-weight-normal mt-2 h6">City</label>
                                                                <div className="">
                                                                    <input
                                                                        id="city"
                                                                        name="city"
                                                                    ...
                                                                    {formikForm.touched.city && formikForm.errors.city ? (
                                                                        <span className="text-danger small">{formikForm.errors.city}</span>
                                                                    ) : null}
                                                                </div>
                                                            </div>
                                                            <div className="col-6">
                                                                <label htmlFor="state" className="font-weight-normal mt-2 h6">State</label>
                                                                <div className="">
                                                                    <input
                                                                        id="state"
                                                                        name="state"
                                                                    ...
                                                                    {formikForm.touched.state && formikForm.errors.state ? (
                                                                        <span className="text-danger small">{formikForm.errors.state}</span>
                                                                    ) : null}
                                                                </div>
                                                            </div>
                                                            <div className="col-6">
                                            ...
                                            <div className='col-6'>
                                                <div className="card">
                                                    <div className='card-header bg-secondary'>
                                                        ...
                                                        <button type='button' className='btn btn-light btn-sm col-2' onClick={() => { setPrevisCompaniesModel(true) }}>Add </button>
                                                    </div>
                                                    <div className="card-body">
                                                        <table className='table'>
                                                            <thead>
                                                            ...
                                                            <tbody>
                                                                {formikForm.values?.previs_companies?.map(coumpany => {
                                                                    return <tr>
                                                                        <td>{coumpany.coumpany_name}</td>
                                                                        <td>{coumpany.from}</td>
                                                                        <td>{coumpany.to}</td>
                                                                        <td><button type='button' className='btn btn-danger btn-sm ' onClick={() => removeCompany(coumpany)}>Remove</button></td>
                                                                    </tr>
                                                                })}
                                                            </tbody>
                                                        </table>
                                            ...
                                            <div className='col-3'>
                                                <div className="card">
                                                    ...
                                                    <div className="card-body">
                                                        <select
                                                            id="mode_of_work_id"
                                                            className={"form-control " + ((formikForm?.errors?.mode_of_work_id) ? " border-danger " : "") + " "}
                                                            name='mode_of_work_id'
                                                            onChange={selectedOption => {
                                                                formikForm.setFieldValue('mode_of_work_id', selectedOption?.target?.value)
                                                            }}
                                                            onBlur={formikForm.handleBlur}>
                                                            <option disabled selected='selected'>Select </option>
                                                            {modeOfWorkListProp?.map(mode =>
                                                                <option value={mode.id} selected={formikForm?.values?.mode_of_work_id == mode.id ? true : false} >{mode.mode_of_work} </option>
                                                            )}
                                                        </select>
                                                        {formikForm.touched.mode_of_work_id && formikForm.errors.mode_of_work_id ? (
                                                            <span className="text-danger">{formikForm.errors.mode_of_work_id}</span>) : null}
                                                    </div>
                                                </div>
                                            </div>
                                            <div className='col-3'>
                                                <div className="card">
                                                    <div className='card-header bg-secondary'>Source of Connection</div>
                                                    <div className="card-body">
                                                        <select
                                                            id="source_id"
                                                            className={"form-control " + ((formikForm?.errors?.source_id) ? " border-danger " : "") + " "}
                                                            name='source_id'
                                                            onChange={selectedOption => {
                                                                formikForm.setFieldValue('source_id', selectedOption?.target?.value)
                                                            }}
                                                            onBlur={formikForm.handleBlur}>
                                                            <option disabled selected='selected'>Select </option>
                                                            {sourceListProp?.map(source => {
                                                                return <option value={source.id} selected={formikForm?.values?.source_id == source.id ? true : false} >{source.source} </option>
                                                            }
                                                            )}
                                                        </select>
                                                        {formikForm.touched.source_id && formikForm.errors.source_id ? (
                                                            <span className="text-danger">{formikForm.errors.source_id}</span>) : null}
                                                    </div>
                                                </div>
                                            </div>
                                            <div className='col-3'>
                                                <div className="card">
                                                    <div className='card-header bg-secondary'>Recruitment Status</div>
                                                    <div className="card-body">
                                                        <select
                                                            id="recruitment_status_id"
                                                            className={"form-control " + ((formikForm.errors.recruitment_status_id) ? " border-danger " : "") + " "}
                                                            name='recruitment_status_id'
                                                            onChange={selectedOption => {
                                                                formikForm.setFieldValue('recruitment_status_id', selectedOption?.target?.value)
                                                            }}
                                                            onBlur={formikForm.handleBlur}>
                                                            <option disabled selected='selected'>Select </option>
                                                            {recruitmentStatusListProps?.map(status => {
                                                                return <option value={status.id} selected={formikForm?.values?.recruitment_status_id == status.id ? true : false} >{status.recruitment_status} </option>
                                                            }
                                                            )}
                                                        </select>
                                                        {formikForm.touched.recruitment_status_id && formikForm.errors.recruitment_status_id ? (
                                                            <span className="text-danger">{formikForm.errors.recruitment_status_id}</span>) : null}
                                                    </div>
                                                </div>
                                            </div>
                                            <div className='col-3'>
                                                <div className="card">
                                                    <div className='card-header bg-secondary'>Other Details</div>
                                                    <div className="card-body">
                                                        ...
                                                        {formikForm.touched.dob && formikForm.errors.dob ? (
                                                            <span className="text-danger small">{formikForm.errors.dob}</span>
                                                        ) : null}
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div>
                <Modal
                    ...
                    <div className='modal-header'>
                        <h4 >Skill Details</h4>
                        <button className='btn btn-danger btn-sm' onClick={() => { setSkillDataModel(false) }}> X</button>
                    </div>
                    <Formik
                        ...
                        validateOnChange={false}
                        validateOnBlur={false}
                        onSubmit={values => { formikSkillForm.handleSubmit(values) }}>
                        {props => (
                            <form onSubmit={props.handleSubmit}>
                                <div className="modal-body">
                                    <div className="form-group row">
                                        ...
                                        <div className='col-9'>
                                            <select
                                                id="skill_master_id"
                                                className={"form-control " + ((formikSkillForm?.errors?.skill_master_id) ? " border-danger " : "") + " "}
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input
                                                ...
                                                name="experience"
                                                type="number"
                                                className={"form-control " + ((formikSkillForm?.errors.experience) ? " border-danger " : "") + " "}
                                                onChange={formikSkillForm.handleChange}
                                                onBlur={formikSkillForm.handleBlur}
                                    ...
                                    <div className="form-group row">
                                        <label htmlFor="self_rating" className="col-sm-3 col-form-label">Rating </label>
                                        <div className="col-sm-9">
                                            <input
                                                id="self_rating"
                                                name="self_rating"
                                                type="self_rating"
                                                className={"form-control " + ((formikSkillForm?.errors.self_rating) ? " border-danger " : "") + " "}
                                                onChange={formikSkillForm.handleChange}
                                                onBlur={formikSkillForm.handleBlur}
                                ...
                                <div className="modal-footer justify-content-between">
                                    <button type="button" className="btn btn-default" data-dismiss="modal" onClick={() => { setSkillDataModel(false) }}>Close</button>
            ...
            <div>
                <Modal
                    ...
                    <div className='modal-header'>
                        <h4 >Skill Details</h4>
                        <button className='btn btn-danger btn-sm' onClick={() => { setPrevisCompaniesModel(false) }}> X</button>
                    </div>
                    <Formik
                        ...
                        validateOnChange={false}
                        validateOnBlur={false}
                        onSubmit={values => { formikPrevisCompaniesForm.handleSubmit(values) }}>
                        {props => (
                            <form onSubmit={props.handleSubmit}>
                                <div className="modal-body">
                                    <div className="form-group row">
                                        <label htmlFor="coumpany_name" className="col-sm-3 col-form-label">Companiey Name </label>
                                        <div className="col-sm-9">
                                            <input
                                                id="coumpany_name"
                                                name="coumpany_name"
                                                type="text"
                                                className={"form-control " + ((formikPrevisCompaniesForm?.errors.coumpany_name) ? " border-danger " : "") + " "}
                                            ...
                                            />
                                            {formikPrevisCompaniesForm.touched.coumpany_name && formikPrevisCompaniesForm.errors.coumpany_name ? (
                                                <span className="text-danger">{formikPrevisCompaniesForm.errors.coumpany_name}</span>
                                            ) : null}
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        <label htmlFor="from" className="col-sm-3 col-form-label">Companiey Name </label>
                                        <div className="col-sm-9">
                                            <input
                                                id="from"
                                                name="from"
                                                type="date"
                                                className={"form-control " + ((formikPrevisCompaniesForm?.errors.from) ? " border-danger " : "") + " "}
                                                onChange={formikPrevisCompaniesForm.handleChange}
                                                onBlur={formikPrevisCompaniesForm.handleBlur}
                                                value={formikPrevisCompaniesForm.values.from}
                                            />
                                            {formikPrevisCompaniesForm.touched.from && formikPrevisCompaniesForm.errors.from ? (
                                                <span className="text-danger">{formikPrevisCompaniesForm.errors.from}</span>
                                            ) : null}
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        <label htmlFor="to" className="col-sm-3 col-form-label">Companiey Name </label>
                                        <div className="col-sm-9">
                                            <input
                                                id="to"
                                                name="to"
                                                type="date"
                                                className={"form-control " + ((formikPrevisCompaniesForm?.errors.to) ? " border-danger " : "") + " "}
                                                onChange={formikPrevisCompaniesForm.handleChange}
                                                onBlur={formikPrevisCompaniesForm.handleBlur}
                                                value={formikPrevisCompaniesForm.values.to}
                                            />
                                            {formikPrevisCompaniesForm.touched.to && formikPrevisCompaniesForm.errors.to ? (
                                                <span className="text-danger">{formikPrevisCompaniesForm.errors.to}</span>
                                            ) : null}
                                        </div>
                                    </div>
                                </div>
                                <div className="modal-footer justify-content-between">
                                    <button type="button" className="btn btn-default" data-dismiss="modal" onClick={() => { setPrevisCompaniesModel(false) }}>Close</button>
                                    <button type='submit' className="btn btn-primary" >Save </button>
                                </div>
                            </form>
                        )}
...
const mapStatetoProps = (state) => {
    return {
        ...
        recruitmentStatusListProps: state?.getActiveRecruitmentStatusReducer?.RecruitmentStatusList,
...
export default connect(mapStatetoProps, mapDispatchtoProps)(InterviewDetailsFormComponent)