...
function ModeOfWorkComponent({
  modeOfWorkListProp,
  modeOfWorkAddedProp,
  modeOfWorkUpdatedProp,
  modeOfWorkRemovedProp,
          ...
          action: (
            <div className="btn-group ">
              ...
              {/* <button
                ...
                onClick={() => onSkillTypeRemove(modeOfWork.id)}
              >
                Remove
              </button> */}
            </div>
  ...
  const onSearchfilter = (event) => {
    if (event?.target?.value) {
      setTableData(
        modeOfWorkList.filter((modeOfWork) =>
  ...
  return (
    <>
      <NevbarComponent
        title={"Mode of Work List"}
        breadcrumbPath={[{ link: "modeofwork", value: "Mode of Work List" }]}
      />
      <SidebarComponent />
